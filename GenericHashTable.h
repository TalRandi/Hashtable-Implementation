...
/**
* This function frees an object, note that if you allocated the data inside the element, it should also be freed.
...
/**
 * This function return the table on doubled size
 */
